 ...
 */
public class NorwayReplacementMapReport extends AbstractOtfMappingReport {
   ...
   */
  private NorwayReplacementMapReport() {
  ...
  public static void runReport() throws Exception {
    ...
    try {
      ...
      emailReportFile("[OTF-Mapping-Tool] Norway Replacement Map Report",
