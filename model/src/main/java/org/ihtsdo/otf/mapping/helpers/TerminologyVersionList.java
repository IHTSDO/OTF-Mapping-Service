...
public class TerminologyVersionList {
   ...
   * 
   * @param TerminologyVersionList the key value pair list
   */
  public void setTerminologyVersionList(
    List<TerminologyVersion> TerminologyVersionList) {
   ...
   * 
   * @param TerminologyVersion the key value pair
   */
  ...
  public int hashCode() {
    final int prime = 31;
    int result = 1;
    result = prime * result + ((terminologyVersionList == null) ? 0
        : terminologyVersionList.hashCode());
    return result;
  }
  ...
  /**
   * Removes the dup scopes.
   */
  public void removeDupScopes() {
    List<TerminologyVersion> tmpList = new ArrayList<>();
    Set<String> observedScopes = new HashSet<>();
  ...
  public String toString() {
    return "TerminologyVersionList [TerminologyVersionList="
        + terminologyVersionList + "]";
  }
}
