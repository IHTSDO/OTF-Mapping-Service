...
public interface ProjectSpecificAlgorithmHandler extends Configurable {
	...
	/**
	 * Compute map advice and map relations. Must be overwritten for each
	 * project handler.
	 * 
	 * @param mapRecord
	 *            the map record
	...
	/**
	 * Set a user's editing on a map record to finished, performing any
	 * necessary workflow actions.
	 * 
	 * @param trackingRecord
	 *            the tracking record
	 * @param mapRecords
	...
	/**
	 * Performs workflow actions necessary when a map user wishes to save a
	 * record for further editing.
	 * 
	 * @param trackingRecord
	 *            the tracking record
	 * @param mapRecords
