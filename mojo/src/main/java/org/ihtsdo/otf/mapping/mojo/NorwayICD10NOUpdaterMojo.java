...
public class NorwayICD10NOUpdaterMojo extends AbstractOtfMappingMojo {
  ...
  public void execute() throws MojoExecutionException, MojoFailureException {
    ...
    try (final ICD10NODownloadAlgorithm algo = new ICD10NODownloadAlgorithm();) {
      ...
      throw new MojoExecutionException("trying to download most recent terminology ICD10NO from API", e
          );
    }
    ...
    //Set the ICD10NO forvaltning project to point to the newly downloaded ICD10NO version
  ...
  private void sendEmail(String fileName) throws Exception {
    ...
    ConfigUtility.sendEmailWithAttachment(
        "[OTF-Mapping-Tool] ICD10NO Updater", from, notificationRecipients,
