...
public class WorkflowTrackingRecordList {
	...
	/** The map projects. */
	private List<WorkflowTrackingRecord> workflowTrackingRecords = new ArrayList<>();
	 ...
	 * 
	 * @param workflowTrackingRecord
	 *            the map project
	 */
	public void addWorkflowTrackingRecord(WorkflowTrackingRecord workflowTrackingRecord) {
	 ...
	 *            the map project
	 */
	public void removeWorkflowTrackingRecord(WorkflowTrackingRecord workflowTrackingRecord) {
	 ...
	 * 
	 * @param workflowTrackingRecords
	 *            the new map projects
	 */
	public void setWorkflowTrackingRecords(List<WorkflowTrackingRecord> workflowTrackingRecords) {
	...
	public void sortWorkflowTrackingRecords() {
		...
		Collections.sort(this.workflowTrackingRecords,
			new Comparator<WorkflowTrackingRecord>() {
				@Override
				public int compare(WorkflowTrackingRecord o1, WorkflowTrackingRecord o2) {
