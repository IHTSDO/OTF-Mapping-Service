...
public class TreePositionDescriptionGroupJpa implements TreePositionDescriptionGroup {
	...
	private List<TreePositionDescription> treePositionDescriptions = new ArrayList<>();
	...
	@Override
	public void setTreePositionDescriptions(List<TreePositionDescription> treePositionDescriptions) {
	...
	public void addTreePositionDescription(TreePositionDescription treePositionDescription) {
		if (this.treePositionDescriptions == null) this.treePositionDescriptions = new ArrayList<>();
		this.treePositionDescriptions.add(treePositionDescription);
	}
	
	@Override
	public void removeTreePositionDescription(TreePositionDescription treePositionDescription) {
		if (this.treePositionDescriptions == null) this.treePositionDescriptions = new ArrayList<>();
