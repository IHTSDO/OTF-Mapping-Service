...
public class TreePositionJpa implements TreePosition {
	...
	/** The children of this TreePosition (NOT persisted) Not persisted -- used for terminology browsing. */
	@Transient
	...
	/* (non-Javadoc)
	 * @see org.ihtsdo.otf.mapping.rf2.TreePosition#setTerminologyNote(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.ihtsdo.otf.mapping.rf2.TreePosition#addChild(org.ihtsdo.otf.mapping.rf2.TreePosition)
	 */
	@Override
