...
// uniqueness
@Table(name = "map_user_preferences", uniqueConstraints = { @UniqueConstraint(columnNames = {
		"mapUser_id", "id" }) })
...
public class MapUserPreferencesJpa implements MapUserPreferences {
	 ...
	 * 
	 * @see
	 * org.ihtsdo.otf.mapping.model.MapUserPreferences#setId(java.lang.Long)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * org.ihtsdo.otf.mapping.model.MapUserPreferences#getLastMapProjectId()
	 */
	@Override
	 ...
	 * 
	 * @param notifiedByEmail
	 *            the new email notifications
	 */
	@Override
	...
	public String toString() {
		return "MapUserPreferencesJpa [id=" + id + ", mapUser=" + mapUser.getUserName()
				+ ", lastLogin=" + lastLogin + ", mapProjectId=" + mapProjectId
				+ ", dashboardModels=" + dashboardModels + ", notifiedByEmail="
				+ notifiedByEmail + ", digestForm=" + digestForm + "]";
	}
