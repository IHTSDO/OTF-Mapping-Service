...
public class ReportJpa implements Report {
  ...
  public String toString() {
    return "ReportJpa [name=" + name + ", active=" + active + ", autoGenerated="
        + autoGenerated + ", reportDefinition=" + reportDefinition.toString()
        + ", timestamp=" + timestamp + ", mapProjectId=" + mapProjectId
        + ", query=" + query + ", queryType=" + queryType + ", resultType="
        + resultType + ", owner=" + owner + ", results=" + results.size()
        + ", notes=" + notes.size() + ", report1Id=" + report1Id
        + ", report2Id=" + report2Id + ", isDiffReport=" + isDiffReport + "]";
  }
