...
/**
 * Converts ICD10CM XML index file to Lucene indexes.
 * 
...
public class IndexXmlToLuceneMojo extends AbstractMojo {
	...
	public void execute() throws MojoExecutionException {
		...
		try {
          ...
          getLog().info("  dictionaryDir: " + dictionaryDir);
			...
			// OPen index writer
			writer =
					new IndexWriter(new MMapDirectory(new File(outputDir)), analyzer,
			...
			// optimize and close Lucene index
			writer.optimize();
			writer.close();
	...
	class LocalHandler extends DefaultHandler {
		...
		/** The in tag. */
		Map<String, Integer> inTag = new HashMap<String, Integer>();

		/** The data. */
		Map<String, String> data = new HashMap<String, String>();

		/** The data stack. */
		Stack<Map<String, String>> dataStack = new Stack<Map<String, String>>();
