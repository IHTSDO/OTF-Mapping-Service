...
set mapping_url=https://norway-mapping-sandbox.terminology.tools/
...
`$MAPPING_CODE/scripts/DeltaSnowstormDataTransfer_NOProjects_Sandbox.sh $project $releaseDate $taskBranch`
exit 1
endif
