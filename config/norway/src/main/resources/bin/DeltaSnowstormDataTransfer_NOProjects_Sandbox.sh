...
MAPPING_CODE=/home/ubuntu/data/mapping-admin
MAPPING_CONFIG=/home/ubuntu/data/mapping-rest/config.properties

USERNAME=wci_map
PASSWORD='nrXHX*4r.2ed%x;4'

snowstorm="https://dailybuild-qa.northeurope.cloudapp.azure.com//snowstorm/snomed-ct/imports/"
...
releaseDir="/home/ubuntu/data/mapping-data/doc/release/SNOMEDCT_NO_to_${project}_${refsetID}/${version}/"
...
if [[ $project == "ICDO" ]]
then
        deltaTransforms="$releaseDir""der2_sRefset_SimpleMapDelta_INT_${version}.txt"
else
...
do
	...
	then
		...
		rm /home/ubuntu/data/mapping-admin/scripts/authenticate
		exit 1
	fi
	sleep 6
done
