...
angular
    ...
    .controller(
        ...
        function($scope, $rootScope, $http, $routeParams, $location,
          ...
          $scope
              .$watch(
                  [ 'focusProject', 'userToken', 'mapProjects' ],
                  function() {
          ...
          $scope.getRecordsForConcept = function() {
            ...
            $http(
                {
                  url : root_mapping + "record/concept/id/"
                      + $routeParams.conceptId,
                  dataType : "json",
                  method : "GET",
                  headers : {
          ...
          $scope.getRecordsForConceptHistorical = function() {
            ...
            $http(
                {
                  url : root_mapping + "record/concept/id/"
                      + $routeParams.conceptId + "/project/id/"
          ...
          $scope.filterRecords = function() {
            ...
            console.debug($scope.recordsInProject.length
                + " records in project " + $scope.focusProject.name);
          ...
          $scope.editRecord = function(record) {
            ...
            if (record.owner.userName === $scope.currentUser.userName
              ...
              console
                  .debug("Edit record clicked, assigning record if necessary");
              $http(
                  {
