...
angular
  ...
  .controller(
    ...
    function($scope, $rootScope, $http, $routeParams, $location,
      ...
      // once focus project, user token, and map projects retrieved, retrieve
        ...
        $http(
          ...
          .success(
            function(data) {
              ...
              // remove records that are already displayed in focus project
              // section
      ...
      $scope.editRecord = function(record) {
        ...
        if (record.owner.userName === $scope.currentUser.userName
          ...
          // if a conflict or review record record, go to conflict resolution
          // page
          ...
          // remove advices if this is a RELATIONSHIP_STYLE project (these are
