...
angular
  ...
  .controller(
    ...
    function($scope, $rootScope, $q, $http, $routeParams, $modal, $location,
      ...
      // for this widget, the only local storage service variable used is user
      // token
      ...
      $scope
        .$on(
          ...
          function(event, parameters) {
            ...
            // if the currently viewed entry is the one being viewed, clear the
            // displayed entry
      ...
      // Function for MapAdvice and MapRelations, returns allowable lists based
        ...
        for (var i = 0; i < relations.length; i++) {
          ...
          if (relations[i].isComputed == false) {
            ...
            if ((nullTarget == true && relations[i].isAllowableForNullTarget == true)
              ...
              // handle a specific case where the name is more descriptive than
              // the abbreviation
