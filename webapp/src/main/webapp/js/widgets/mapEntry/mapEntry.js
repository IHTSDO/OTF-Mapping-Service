    ...
    .controller(
        ...
        function($scope, $rootScope, $q, $http, $routeParams, $modal,
          ...
          $scope
              .$on(
                  ...
                  function(event, parameters) {
                    console
                        .debug("MapEntryWidget: Detected change in selected entry");
                    ...
                    console
                        .debug("MapEntryWidget: mapRecord = ", $scope.record);

                    // get the allowable advices
                    $scope.allowableAdvices = getAllowableAdvices(
                        parameters.entry, parameters.project.mapAdvice);
          ...
          $scope.openRuleConstructor = function() {
            ...
            modalInstance.result
                .then(function(rule) {
                  ...
                  $scope.entry.ruleSummary = $scope
                      .getRuleSummary($scope.entry);
          ...
          var RuleConstructorModalCtrl = function($scope, $http,
            ...
            $scope.ruleCategories = [ 'TRUE', 'Gender - Male',
                'Gender - Female', 'Age - Chronological', 'Age - At Onset' ];
          ...
          $scope.computeParameters = function(ignoreNullValues) {
            ...
            console.debug("Computing parameters", targetNotNull,
                relationNotNull);
