      ...
      function($scope, $http, $sce, $rootScope, $location, localStorageService,
        ...
        $scope.getNonDiffReportDefinitionNames = function() {
          ...
          for (var i = 0; i < $scope.reportDefinitions.length; i++) {
            console.debug($scope.reportDefinitions[i].diffReport);
        ...
        $scope.validateReportDefinition = function(name, roleRequired,
          resultType, queryType, diffReport, timePeriod, diffReportDefinition,
          frequency, query) {
        ...
        $scope.testReportDefinition = function(name, roleRequired, resultType,
          queryType, diffReport, timePeriod, diffReportDefinition, frequency,
          query) {

          console.debug("Testing report definition");

          // if validation returns an error, simply return
          if ($scope.validateReportDefinition(name, roleRequired, resultType,
            queryType, diffReport, timePeriod, diffReportDefinition, frequency,
            query) != true)
            return;
