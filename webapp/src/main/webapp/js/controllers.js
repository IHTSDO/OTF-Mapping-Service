  ...
  .controller(
    ...
    [
      ...
      function($scope, localStorageService, $rootScope, $location, $http) {
        ...
        // set the user, role, focus project, and preferences to null (i.e.
        // clear)
                  ...
                  $http({
                    ...
                    .success(
                      function(data) {
                        ...
                        console.debug('map projects', data.mapProject);
                                  ...
                                  function(data) {
                                    ...
                                    for (var i = 0; i < $scope.mapProjects.length; i++) {
                                      ...
                                      if ($scope.mapProjects[i].id === $scope.preferences.lastMapProjectId) {
                                        ...
                                        console.debug("Found project");
                                      }
                                    }

                                    // if project not found, set to first
                                    // retrieved project
                                    ...
                                    $http(
                                      ...
                                      .success(
                                        function(data) {
                                          ...
                                          // add the user information to local
                                          // storage
                                          localStorageService.add(
                                            'currentRole', $scope.role);

                                          // broadcast the user information to
                                          // rest of app
                                          $rootScope
                                            .$broadcast(
