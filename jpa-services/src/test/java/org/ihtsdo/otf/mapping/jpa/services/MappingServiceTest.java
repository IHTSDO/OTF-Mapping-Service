...
public class MappingServiceTest {
	...
	public void testRetrieveElements() throws Exception {
		...
		System.out.println(Integer.toString(projects.size())
				+ " projects found");
		System.out.println(Integer.toString(specialists.size())
				+ " specialists found");
		...
		for (MapProject m : projects) {
			...
			System.out.println("Successful retrieval by id= "
					+ mp.getId().toString());
		}

		// Test retrieval of projects by specialist
		for (MapSpecialist m : specialists) {
			System.out.println("Projects for specialist "
					+ m.getId().toString() + ", " + m.getName());
		...
		for (MapLead m : leads) {
			System.out.println("Projects for lead " + m.getId().toString()
					+ ", " + m.getName());
