...
/**
 * Implementation of {@link MetadataService} for terminologies loaded using the Simple Loader.
 * 
 */
public class SimpleMetadataServiceJpaHelper extends RootServiceJpa
  ...
  private List<Concept> getDescendantConcepts(ContentService contentService,
    ...
    if (concept == null) {
      throw new Exception("Cannot locate the Simple Metadata concept");
    }
