...
public class ReportServiceJpa extends RootServiceJpa implements ReportService {
	 ...
	 */
	@SuppressWarnings("unused")
	private ReportResultItemList getReportResultItemsAdded(
			ReportResult result1, ReportResult result2) {
	 ...
	 */
	@Override
	public void removeQACheckDefinition(Long qaCheckDefinitionId)
			throws Exception {

		ReportDefinition qaCheckDefinition = manager.find(
				ReportDefinitionJpa.class, qaCheckDefinitionId);
