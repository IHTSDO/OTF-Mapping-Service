  ...
  private void cacheCodes() throws Exception {
    ...
    if(ICD10CACodeSet.isEmpty() || ICD9CodeSet.isEmpty() || CEDDxSCodeSet.isEmpty()) {
      ...
      CEDDxSCodeSet.addAll(Arrays.asList(new String[] {
          ...
          "E88.9", "F03", "F05.9", "F07.2", "F10.0", "F10.3", "F11.9", "F12.9", "F12.90", "F13.9", "F14.9",
          "F15.9", "F15.99", "F16.9", "F18.9", "F19.9", "F19.998", "F20.9", "F23.9", "F31.9", "F32.9", "F41.9",
          ...
          "K07.69", "K08.87", "K08.9", "K11.9", "K13.7", "K14.9", "K20", "K20.9", "K21.9", "K22.2",
          ...
          "R17", "R17.0", "R18", "R20.8", "R21", "R22.9", "R25.8", "R26.88", "R30.0", "R31.8", "R33",
          ...
          "T39.9", "T40.1", "T40.5", "T40.6", "T40.7", "T40.79", "T40.9", "T42.4", "T43.9", "T46.9", "T50.9",
