  ...
  private void cacheCodes() throws Exception {
    ...
    if (ICD10CACodeSet.isEmpty() || ICD9CodeSet.isEmpty() || CEDDxSCodeSet.isEmpty()) {
      ...
      CEDDxSCodeSet.addAll(Arrays.asList(new String[] {
          ...
          "A86", "A87.9", "B00.9", "B01.9", "B02.9", "B04", "B05.9", "B06.9", "B08.3", "B08.4",
          "B09", "B19.9", "B24", "B26.9", "B27.9", "B34.9", "B37.9", "B49", "B54", "B58.9", "B83.9",
          ...
          "J05.0", "J05.1", "J06.9", "J09", "J11.8", "J18.9", "J20.9", "J21.9", "J32.9", "J36", "J38.7",
