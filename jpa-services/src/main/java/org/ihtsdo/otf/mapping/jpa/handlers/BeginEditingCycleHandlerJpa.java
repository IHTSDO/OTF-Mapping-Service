...
public class BeginEditingCycleHandlerJpa implements BeginEditingCycleHandler {
  ...
  /* (non-Javadoc)
   * @see org.ihtsdo.otf.mapping.services.helpers.StartEditingCycleHandler#close()
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see org.ihtsdo.otf.mapping.services.helpers.StartEditingCycleHandler#setMapProject(org.ihtsdo.otf.mapping.model.MapProject)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see org.ihtsdo.otf.mapping.services.helpers.BeginEditingCycleHandler#startEditingCycle()
   */
  @Override
