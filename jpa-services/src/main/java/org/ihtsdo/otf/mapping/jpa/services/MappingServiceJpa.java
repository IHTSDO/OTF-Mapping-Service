...
public class MappingServiceJpa implements MappingService {
  ...
  public MapAdviceList computeMapAdvice(MapEntry mapEntry)
    ...
    mapAdviceList.setMapAdvices(algorithmHandler.computeMapAdvice(mapRecord,
        mapEntry));
   ...
   * 
   * @see
   * org.ihtsdo.otf.mapping.services.MappingService#getMapRecordRevisions(java
   * .lang.Long)
   */
  @Override
  ...
  public MapRecordList getMapRecordsForMapProject(Long mapProjectId,
    ...
    mapRecordList.setTotalCount(getMapRecordCountForMapProject(mapProjectId,
        pfsParameter));
    return mapRecordList;
   ...
   * 
   * @see
   * org.ihtsdo.otf.mapping.services.MappingService#removeMapAgeRange(java.lang
   * .Long)
   */
  @Override
   ...
   * 
   * @see
   * org.ihtsdo.otf.mapping.services.MappingService#addMapUserPreferences(org
   * .ihtsdo.otf.mapping.model.MapUserPreferences)
   */
  @Override
  ...
  public void setTreePositionValidCodesHelper(List<TreePosition> treePositions,
    ...
    // cycle over all tree positions and check target code, recursively cycle
    // over children
  ...
  public Map<Long, Long> compareFinishedMapRecords(MapProject mapProject)
    ...
    for (Entry<MapRecord, MapRecord> entry : finishedPairsForComparison
      ...
      ValidationResult result =
          handler.compareMapRecords(entry.getKey(), entry.getValue());
      if (!result.isValid()) {
