...
/**
 * Implementation of {@link MetadataService} for ICD10CA terminology.
 * 
 */
public class ICD10CAMetadataServiceJpaHelper extends RootServiceJpa
  ...
  private List<Concept> getDescendantConcepts(ContentService contentService,
    ...
    if (concept == null) {
      throw new Exception("Cannot locate the ICD10CA Metadata concept");
    }
