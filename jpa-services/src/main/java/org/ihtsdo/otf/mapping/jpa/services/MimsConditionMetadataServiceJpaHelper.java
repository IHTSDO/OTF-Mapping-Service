...
/**
 * Implementation of {@link MetadataService} for MIMS Condition terminology.
 * 
 */
public class MimsConditionMetadataServiceJpaHelper extends RootServiceJpa
  ...
  private List<Concept> getDescendantConcepts(ContentService contentService,
    ...
    if (concept == null) {
      throw new Exception("Cannot locate the MIMS Condition Metadata concept");
    }
