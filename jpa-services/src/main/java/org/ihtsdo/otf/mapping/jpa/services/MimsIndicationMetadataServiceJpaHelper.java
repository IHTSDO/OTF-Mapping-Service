...
/**
 * Implementation of {@link MetadataService} for MIMS Indication terminology.
 * 
 */
public class MimsIndicationMetadataServiceJpaHelper extends RootServiceJpa
  ...
  private List<Concept> getDescendantConcepts(ContentService contentService,
    ...
    if (concept == null) {
      throw new Exception("Cannot locate the MIMS Indication Metadata concept");
    }
