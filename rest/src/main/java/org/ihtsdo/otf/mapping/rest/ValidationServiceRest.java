...
public class ValidationServiceRest {
	...
	public ValidationResult validateMapRecord(@ApiParam(value = "The map record to validate.  Must exist in mapping database. Must be in Json or Xml format", required = true) MapRecordJpa mapRecord) { 
	
		Logger.getLogger(MappingServiceRest.class).info("RESTful call (Validation): /record/validate");
