  ...
  public MapRecordListJpa getMapRecordsForMapProjectAndQuery(
    ...
    try {
      ...
      if (ancestorId != null && !ancestorId.isEmpty()
        ...
        TreePositionList tpList = contentService.getTreePositions(ancestorId,
        ...
        Logger.getLogger(getClass())
            .info("Searching for map records for descendants of path " + path);
        ...
        Logger.getLogger(getClass())
            .info("  " + searchResults.getTotalCount() + " map records found");
