...
public class WorkflowServiceRest {
  ...
  public SearchResultList findAvailableWork(
    ...
    try {
      ...
      Logger.getLogger(WorkflowServiceRest.class).info(
          "RESTful call for project " + mapProject.getName() + " and user "
              + mapUser.getName() + " for index ["
      ...
      SearchResultList results =
          workflowService.findAvailableWork(mapProject, mapUser, pfsParameter);
      workflowService.close();
  ...
  public SearchResultList findAssignedWork(
    ...
    try {
      ...
      WorkflowService workflowService = new WorkflowServiceJpa();
      SearchResultList results =
          workflowService.findAssignedWork(mapProject, mapUser, pfsParameter);
      workflowService.close();
  ...
  public SearchResultList findAvailableConflicts(
    ...
    try {
      ...
      WorkflowService workflowService = new WorkflowServiceJpa();
      SearchResultList results =
          workflowService.findAvailableConflicts(mapProject, mapUser,
              pfsParameter);
      workflowService.close();
  ...
  public SearchResultList findAssignedConflicts(
    ...
    try {
      ...
      WorkflowService workflowService = new WorkflowServiceJpa();
      SearchResultList results =
          workflowService.findAssignedConflicts(mapProject, mapUser,
              pfsParameter);
      workflowService.close();
  ...
  public Response assignBatch(
    ...
    Logger.getLogger(WorkflowServiceRest.class).info(
        "RESTful call: assignBatchToUser");
