...
public interface WorkflowService extends MappingService {
	 ...
	 *             the exception
	 */
	public void updateTrackingRecord(TrackingRecord trackingRecord) throws Exception;
	 ...
	 *             the exception
	 */
	public SearchResultList findAvailableWork(MapProject mapProject, MapUser mapUser, String query,
	...
	Set<MapRecord> synchronizeMapRecords(TrackingRecord trackingRecord, Set<MapRecord> mapRecords) throws Exception;
	 ...
	 *
	 * @param workflowExceptiondId
	 *            the workflow exceptiond id
	 * @throws Exception
	 *             the exception
	 */
	 ...
	 *             the exception
	 */
	public WorkflowException addWorkflowException(WorkflowException workflowException) throws Exception;
